...
<head>
    ...
    <!-- Favicon -->
    <link href="{{ url('proMan/img/favicon.ico') }}" rel="icon">
    ...
    <link href="{{ url('proMan/lib/animate/animate.min.css') }}" rel="stylesheet">
    <link href="{{ url('proMan/lib/lightbox/css/lightbox.min.css') }}" rel="stylesheet">
    <link href="{{ url('proMan/lib/owlcarousel/assets/owl.carousel.min.css') }}" rel="stylesheet">

    <!-- Customized Bootstrap Stylesheet -->
    <link href="{{ url('proMan/css/bootstrap.min.css') }}" rel="stylesheet">

    <!-- Template Stylesheet -->
    <link href="{{ url('proMan/css/style.css') }}" rel="stylesheet">
</head>
...
<body data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="51">
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 py-6 pb-0 pt-lg-0">
                    ...
                    <h1 class="display-3 mb-3">Buddhi Thapa</h1>
                    <h2 class="typed-text-output d-inline"></h2>
                    <div class="typed-text d-none"> Web Developer (Laravel ,Reactjs), Front End Developer, Back End Devloper</div>
                    <div class="d-flex align-items-center pt-5">
                        <a href="" class="btn btn-primary py-3 px-4 me-5">Download CV</a>
                        <button type="button" class="btn-play" data-bs-toggle="modal"
                            data-src="https://www.youtube.com/embed/0yVDMcGp97g" data-bs-target="#videoModal">
                            <span></span>
                        </button>
                ...
                <div class="col-lg-6">
                    <img class="img-fluid" src="{{ url('proMan/img/pro.png') }}" alt="">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="d-flex align-items-center mb-5">
                        ...
                        <h3 class="lh-base mb-0">of working experience as a Full-Stack Devloper </h3>
                    </div>
                    <p class="mb-4">Wroking on Front-End <strong>React JS</strong>  and for  Back-end <strong> PHP ,Laravel </strong> For the database  <strong>MYSQL</strong> In Additional I know <strong> Jquery,JavaScript,Ajax,JSON </strong>.</p>
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="row g-3 mb-4">
                        <div class="col-sm-6">
                            <img class="img-fluid rounded" src="{{ url('proMan/img/about-1.jpg') }}" alt="">
                        </div>
                        <div class="col-sm-6">
                            <img class="img-fluid rounded" src="{{ url('proMan/img/about-2.jpg') }}" alt="">
                        </div>
                    </div>
                    <div class="d-flex align-items-center mb-3">
                        <h5 class="border-end pe-3 me-3 mb-0">Happy Clients</h5>
                        <h2 class="text-primary fw-bold mb-0" data-toggle="counter-up">8</h2>
                    </div>
            ...
            <div class="row g-4 portfolio-container wow fadeInUp" data-wow-delay="0.1s">
                <div class="col-lg-4 col-md-6 portfolio-item first">
                    <div class="portfolio-img rounded overflow-hidden">
                        <img class="img-fluid" src="{{ url('proMan/img/project-1.jpg') }}" alt="">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item second">
                    <div class="portfolio-img rounded overflow-hidden">
                        <img class="img-fluid" src="{{ url('proMan/img/project-2.jpg') }}" alt="">
                        <div class="portfolio-btn">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item first">
                    <div class="portfolio-img rounded overflow-hidden">
                        <img class="img-fluid" src="{{ url('proMan/img/project-3.jpg') }}" alt="">
                        <div class="portfolio-btn">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item second">
                    <div class="portfolio-img rounded overflow-hidden">
                        <img class="img-fluid" src="{{ url('proMan/img/project-4.jpg') }}" alt="">
                        <div class="portfolio-btn">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item first">
                    <div class="portfolio-img rounded overflow-hidden">
                        <img class="img-fluid" src="{{ url('proMan/img/project-5.jpg') }}" alt="">
                        <div class="portfolio-btn">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item second">
                    <div class="portfolio-img rounded overflow-hidden">
                        <img class="img-fluid" src="{{ url('proMan/img/project-6.jpg') }}" alt="">
                        <div class="portfolio-btn">
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item position-relative">
                        <img class="img-fluid rounded" src="{{ url('proMan/img/team-1.jpg') }}" alt="">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-item position-relative">
                        <img class="img-fluid rounded" src="{{ url('proMan/img/team-2.jpg') }}" alt="">
                        <div class="team-text bg-white rounded-end p-4">
                            <div>
                                <h5>Full Name</h5>
                                <span>Designer</span>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="team-item position-relative">
                        <img class="img-fluid rounded" src="{{ url('proMan/img/team-3.jpg') }}" alt="">
                        <div class="team-text bg-white rounded-end p-4">
                            <div>
                                <h5>Full Name</h5>
                                <span>Designer</span>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-3 d-none d-lg-block">
                    <div class="testimonial-left h-100">
                        <img class="img-fluid wow fadeIn" data-wow-delay="0.1s" src="{{ url('proMan/img/testimonial-1.jpg') }}" alt="">
                        <img class="img-fluid wow fadeIn" data-wow-delay="0.3s" src="{{ url('proMan/img/testimonial-2.jpg') }}" alt="">
                        <img class="img-fluid wow fadeIn" data-wow-delay="0.5s" src="{{ url('proMan/img/testimonial-3.jpg') }}" alt="">
                    </div>
                </div>
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="owl-carousel testimonial-carousel">
                        <div class="testimonial-item text-center">
                            <div class="position-relative mb-5">
                                <img class="img-fluid rounded-circle border border-secondary p-2 mx-auto" src="{{ url('proMan/img/testimonial-1.jpg') }}" alt="">
                        ...
                        <div class="testimonial-item text-center">
                            <div class="position-relative mb-5">
                                <img class="img-fluid rounded-circle border border-secondary p-2 mx-auto" src="{{ url('proMan/img/testimonial-2.jpg') }}" alt="">
                                <div class="testimonial-icon">
                                    <i class="fa fa-quote-left text-primary"></i>
                                </div>
                            </div>
                        ...
                        <div class="testimonial-item text-center">
                            <div class="position-relative mb-5">
                                <img class="img-fluid rounded-circle border border-secondary p-2 mx-auto" src="{{ url('proMan/img/testimonial-3.jpg') }}" alt="">
                                <div class="testimonial-icon">
                                    <i class="fa fa-quote-left text-primary"></i>
                                </div>
                            </div>
    ...
    <div class="container-xxl pt-5 px-0 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container-xxl pt-5 px-0">
            <div class="bg-dark">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d235526.90924712367!2d75.7237618214095!3d22.724228429904368!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3962fcad1b410ddb%3A0x96ec4da356240f4!2sIndore%2C%20Madhya%20Pradesh!5e0!3m2!1sen!2sin!4v1663853845245!5m2!1sen!2sin"  frameborder="0" style="width: 100%; height: 450px; border:0;" allowfullscreen="" aria-hidden="false"
                tabindex="0"></iframe>
                {{-- <iframe
    ...
    <script src="{{ url('proMan/lib/wow/wow.min.js') }}"></script>
    <script src="{{ url('proMan/lib/easing/easing.min.js') }}"></script>
    <script src="{{ url('proMan/lib/waypoints/waypoints.min.js') }}"></script>
    <script src="{{ url('proMan/lib/typed/typed.min.js') }}"></script>
    <script src="{{ url('proMan/lib/counterup/counterup.min.js') }}"></script>
    <script src="{{ url('proMan/lib/owlcarousel/owl.carousel.min.js') }}"></script>
    <script src="{{ url('proMan/lib/isotope/isotope.pkgd.min.js') }}"></script>
    <script src="{{ url('proMan/lib/lightbox/js/lightbox.min.js') }}"></script>

    <!-- Template Javascript -->
    <script src="{{ url('proMan/js/main.js') }}"></script>
</body>
